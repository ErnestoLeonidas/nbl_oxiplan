...
var tablaReporte = function (){
    tablita = $('#tablaBusquedaPlanos').DataTable( {
...
var registrarPlanos = function (tablita) {
    $("#btnRegistrarPlano").on("click", function () {
        ...
        if (validarCmbZona() && validarCmbEspecialidades()
            ...
            */
            ...
            $('#validar').html('<strong>FALTAN DATOS</strong>');
...
function cargarPlano(idZona, idEspecialidad, descripcion_zona, descripcion_proyecto,
    ...
    codigo_UEN, idUEN, codigo_Zona, accion, tablita) {
    ...
    $.ajax({
        ...
        success:  function (response) { //una vez que el archivo recibe el request lo procesa y lo devuelve
            ...
            setTimeout(function(){
                ...
                $("#valorRegistrado").text(response)
    
                //actualizarBusquedaPlanos(tablita);
            }, 2000); 
            
            limpiarFormulario(tablita, idZona, codigo_Plano)
...
function limpiarFormulario(val, idz, idcodp ){
    //limpiar los cmb
    //$("#cmbZona").empty();
    ...
    //actualizar form con el último registro
    ...
    switch (localidad) {
        ...
        case 'Concepción - Planta Resinas':
            array = { 
                    ...
                    _Descripcion_Zona : "PLANTA RESINAS CONCEPCION"
                    };
            return array;
